...
# Cliff Walking by using the Q-learning method.
...
if __name__ == '__main__':
    ...
    for episode in range (10000):
        ...
        while not grid.game_over():
            ...
            a2, maxQs2a2 = argmax_max_dict(Q[s2])
    ...
    with open('cliff_q_rewards.csv', "a") as output_file:
        writer = csv.writer(output_file)
        writer.writerow(running_average)

    with open('cliff_q_deltas.csv', "a") as output_file:
        writer = csv.writer(output_file)
